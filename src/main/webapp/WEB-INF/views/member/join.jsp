...
<head>
	...
	<link rel="stylesheet" type="text/css"  href="/resources/css/member/join.css?after">
...
var code = "";		// 이메일전송 인증번호 저장위한 코드
	...
	/* 유효성 검사 통과유무 변수 */
	var idck		= false;
	var idck_check	= false;
	var pwck		= false;
	var pwck_check	= false;
	var pwckck		= false;
	var nameck		= false;
	var emailck		= false;
...
$(document).ready(function() {
	...
	$(".join_button").click(function() {
		...
		var pwck	= $(".pwck_input").val();			// 비밀번호 확인 인력란
