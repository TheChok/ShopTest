...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/css/admin/goodsModify.css?after">
...
<body>
	...
	<%@include file="../includes/admin/header.jsp" %>
		...
		<div class="admin_content_wrap">
				...
				<form action="/admin/goodsModify" method="post" id="modifyForm">
					<div class="form_section">
						...
						<div class="form_section_content">
							<input name="book_name" value="${goodsInfo.book_name }"/>
					...
					<div class="form_section">
						...
						<div class="form_section_content">
							<input id="author_name_input" readonly="readonly" value="${goodsInfo.author_name }"/>
							<input id="author_id_input" name="author_id" type="hidden" value="${goodsInfo.author_id }"/>
							<button class="author_id_btn">작가 선택</button>
							<span class="ck_warn author_id_wran">작가를 선택해주세요</span>
						</div>
					</div>
					<div class="form_section">
						<div class="form_section_title">
					...
					<div class="form_section">
						...
						<div class="form_section_content">
							<input name="book_price" value="${goodsInfo.book_price }"/>
					...
					<div class="form_section">
						...
						<div class="form_section_content">
							<input name="book_stock" value="${goodsInfo.book_stock }"/>
							<span class="ck_warn book_price_warn">상품 재고를 입력해주세요.</span>
						</div>
					</div>
					<div class="form_section">
						<div class="form_section_title">
						...
						<div class="form_section_content">
							...
							<input name="book_discount" type="hidden" value="${goodsInfo.book_discount }"/>
							<span class="step_val">할인 가격 : <span class="span_discount"></span></span>
							<span class="ck_warn book_discount_warn">1~99 숫자를 입력해주세요.</span>
						</div>
					</div>
					<div class="form_section">
						<div class="form_section_title">
						...
						<div class="form_section_content">
							<textarea name="book_intro" id="book_intro_textarea">${goodsInfo.book_intro }</textarea>
					...
					<input type="hidden" name="book_id" value="${goodsInfo.book_id }"/>
				</form>
			...
			<form id="moveForm" action="/admin/goddsManage" method="get">
...
<script>
	...
	/* 위지윅 적용 */
		...
		/* 할인율 인터페이스 출력 */
		let bookPriceInput = $("input[name='book_price']");
		let discountInput = $("input[name='book_discount']");
		...
		$("#discount_interface").on("propertychange change keyup paste input", function(){
			...
			let goodsPrice = $("input[name='book_price']").val();		// 원가
