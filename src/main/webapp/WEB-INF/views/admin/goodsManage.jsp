...
<body>
	...
	<%@ include file="../includes/admin/header.jsp" %>
	    ...
	    <div class="admin_content_wrap">
	        	...
	        	<c:if test="${listCheck != 'empty' }">
	        		<table class="goods_table">
	        			...
	        			<c:forEach items="${list }" var="list">
	        				<tr>
	        					<td><c:out value="${list.book_id}"></c:out></td>
	        					<td>
	        						<a class="move" href="<c:out value='${list.book_id }'/>">
	        							<c:out value="${list.book_name}"></c:out>
	        						</a>
	        					</td>
	        					<td><c:out value="${list.author_name}"></c:out></td>
	        					<td><c:out value="${list.cate_name}"></c:out></td>
	        					<td><c:out value="${list.book_stock}"></c:out></td>
	        ...
	        </div>	<!-- End - class="goods_table_wrap" -->
...
$(".move").on("click", function(e) {
	...
	moveForm.append("<input type='hidden' name='book_id' value='"+$(this).attr("href")+"'/>");
