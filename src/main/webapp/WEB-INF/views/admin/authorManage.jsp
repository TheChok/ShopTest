...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/css/admin/authorManage.css?after">
...
<body>
	...
	<%@ include file="../includes/admin/header.jsp" %>
		...
		<div class="admin_content_wrap">
			       	...
			       	<table class="author_table">
			       		...
			       		<c:forEach items="${list}" var="list">
			       			<tr>
		       					...
		       					<td>
		       						<a class="move" href="${list.author_id }">
			       				...
			       				<td><fmt:formatDate value="${list.updatedate}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
			       			</tr>
			       		</c:forEach>
			       	</table>
		       	</c:if>
	       	...
	       	</div>	<!-- End - class="author_table_wrap" -->
...
$(".move").on("click", function(e) {
	...
	moveForm.append("<input type='hidden' name='author_id' value='"+ $(this).attr("href") +"'/>");
