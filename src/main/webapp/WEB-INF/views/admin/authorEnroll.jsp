...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/resources/css/admin/authorEnroll.css?after">
	...
	<div class="wrap">
		...
		<div class="admin_wrap">
			...
			<div class="admin_navi_wrap">
			    <ul>
			        <li >
			            <a class="admin_list_01"
			            href="/admin/goodsEnroll">상품 등록</a>
			        </li>
			        <li>
			        ...
			        <lI>
			            ...
			            href="/admin/authorEnroll">작가 등록</a>                            
			        </lI>
			        <lI>
			            <a class="admin_list_04"
			            href="/admin/authorManage">작가 관리</a>                            
			        </lI>
			        <lI>
			            <a class="admin_list_05"
			            href="#">회원 관리</a>                            
			        </lI>                                                                                             
			    </ul>
	    	</div>
					...
					<form action="/admin/authorEnroll.do" method="post" id="enrollForm">
						...
						<div class="form_section">
							...
							<div class="form_section_content">
								...
								<span id="warn_nation_id">소속 국가를 선택해주세요.</span>
							</div>
						</div>
						...
						<div class="form_section">
							...
							<div class="form_section_content">
								<input name="author_intro" type="text"/>
								<span id="warn_author_intro">작가 소개을 입력해주세요.</span>
							</div>
						</div>
					</form>	<!-- End - Form -->
...
$("#enrollBtn").click(function(){    
    ...
    /* 입력값 변수 */
    let authorName = $('input[name=author_name]').val();        // 작가 이름
    let nationId = $('select[name=nation_id]').val();        // 소속 국가
    let authorIntro = $('input[name=author_intro]').val();    // 작가 소개
    /* 공란 경고 span태그 */
    let wAuthorName = $('#warn_author_name');
    let wNationId = $('#warn_nation_id');
    let wAuthorIntro = $('#warn_author_intro');    
